          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 text-sm">
                Comprehensive student records including personal details, academic history, and enrollment information.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Results & Assessments</h4>
              <p className="text-gray-600 text-sm">
                Record and compute examination results, generate report cards, and track academic performance.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Attendance Tracking</h4>
              <p className="text-gray-600 text-sm">
                Daily attendance records with reports and analytics to monitor student presence.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Class Management</h4>
              <p className="text-gray-600 text-sm">
                Organize classes, assign teachers, and manage class arms across different levels.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Fee Management</h4>
              <p className="text-gray-600 text-sm">
                Track school fees, generate payment records, and manage financial transactions.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Parent Portal</h4>
              <p className="text-gray-600 text-sm">
                Parents can view their children&apos;s progress, results, and school communications.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href={paths.auth.signIn} className="hover:text-white transition-colors">Sign In</Link></li>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
            <p>&copy; {new Date().getFullYear()} UI Staff School. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </main>
